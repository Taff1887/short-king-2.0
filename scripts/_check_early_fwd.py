"""Why is fwd_ret_4w all-NaN for 2010-2011 monthly dates?"""
...
print(f"TLS on 2010-06 to 2010-10 panel:\n{tls_panel[['Date', 'Symbol', 'adjClose', 'fwd_ret_1w', 'fwd_ret_4w', 'fwd_ret_12w']].head(10).to_string(index=False)}")
print()
...
print(f"  fwd_ret_4w non-null: {early['fwd_ret_4w'].notna().sum():,}")
print(f"  fwd_ret_12w non-null: {early['fwd_ret_12w'].notna().sum():,}")
